...
@section('content')
    <div class="row justify-content-around">
        ...
        <form action="{{ route('photos.upload',[$album->id]) }}" method="post" enctype="multipart/form-data" class="form">
            @csrf
            <input type="file" name="images[]" class="btn btn-primary" accept="image/*" multiple>
