...
Route::prefix('admin')->group(function () {
    ...
    Route::get('album/{Album}', [AlbumsController::class, 'showImages'])->name('album.show');
    Route::post('photos/upload/{Album}',[PhotosController::class,'upload'])->name('photos.upload');
});
